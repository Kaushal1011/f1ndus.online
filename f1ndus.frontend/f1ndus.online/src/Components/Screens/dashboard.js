...
const Dashboard = () => {
  ...
  useEffect(() => {
    navigator.geolocation.getCurrentPosition(function (position) {
      ...
      const apiUrl = `http://${server_addr}/api/v1/findpost`;
